...
options.register('inputDataset',
                 ...
                 "Input dataset")
options.register('isTrainSample', False, VarParsing.multiplicity.singleton, VarParsing.varType.bool, "if the sample is used for training")
...
# DeepNtuplizer
process.load("DeepNTuples.Ntupler.DeepNtuplizer_Zprime_cfi")
